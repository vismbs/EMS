    ...
    Print_Data(String e_id) {
        try {
            ...
            while (rs.next()) {
                ...
                education = rs.getString("empEdu");
                post = rs.getString("empPost");
                aadhar = rs.getString("empAadhar");
        ...
        id9.setLayout(null);
        ImageIcon img = new ImageIcon("C:\\Users\\vmcri\\IdeaProjects\\EmployeeManagementSystem\\src\\main\\java\\icons\\print.jpg");
        id9.setIcon(img);
