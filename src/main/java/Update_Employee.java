...
class Update_Employee extends Add_Employee implements ActionListener {
    ...
    void showData(String s) {
        try {
            ...
            ResultSet rs = con.statementInst.executeQuery(str);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b && i == 1) {
            try {
                DBConn con = new DBConn();
                String str = "update Employee set empName='" + t1.getText() + "',empFather='" + t2.getText() + "',empAge='" + age + "',empDOB='" + dat + "',empAddress='" + t3.getText() + "',empPhone='" + t4.getText() + "',empEmail='" + t5.getText() + "',empEdu='" + t6.getText() + "',empPost='" + t7.getText() + "',empAadhar='" + t8.getText() + "',empID='" + t9.getText() + "' where empId'" + id_emp + "'";
                con.statementInst.executeUpdate(str);
